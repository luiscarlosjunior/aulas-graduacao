...
public class ServletLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Por padrão vamos chamar a página index e passamos erro=1
            String pagina = "index.jsp?erro=1";
            
            // validar se o usuário é igual a admin e senha = 123
            ...
            if(oAcao.equals("login")) {
                if(user.equals("admin") && pwd.equals("123")) {
                    ...
                    // Criar um objeto para sessão do JSP
                    HttpSession sessao = request.getSession();
                    
                    // Definir um atribuito para esta sessão criada
                    sessao.setAttribute("login", request.getParameter("login"));
                    
                    // Se tiver sucesso página inicial
                    pagina = "index.jsp";
                }
