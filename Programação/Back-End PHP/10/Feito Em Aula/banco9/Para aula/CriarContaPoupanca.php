...
<html>
	...
	<header>
		...
		<main>
			<form action="CriarContaPoupanca.php" method="post">
                ...
                <label for="investimento">Período de investimento</label>
				<select name="investimento" class="input-padrao">
					<option value="cincoanos">5 anos</option>
					<option value="dezanos">10 anos</option>
					<option value="quinzeanos"> 15 anos</option>
				</select>
