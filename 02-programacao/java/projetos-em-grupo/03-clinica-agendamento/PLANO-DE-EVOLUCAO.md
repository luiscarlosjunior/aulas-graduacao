...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o horário da consulta (marcaram para as 25h!). Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.clinica.{dominio,aplicacao,infra}`).
