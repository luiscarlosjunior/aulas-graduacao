...
> **Cliente (dono de uma clínica):** *"Minha ideia é simples: preciso organizar os pacientes. Hoje faço
> tudo no caderno e me perco. Queria começar só cadastrando e vendo a lista. Depois a gente
> incrementa — já sei que vou precisar registrar as consultas de cada médico, mas uma coisa de cada vez."*
>
...
> guardar e fazer sobre pacientes e sobre cada consulta."*
>
...
> **Cliente:** *"Tem uma regra que NÃO pode falhar de jeito nenhum: não pode marcar dois pacientes no mesmo horário do mesmo médico. Se isso
> acontecer, é prejuízo e dor de cabeça na certa."*
>
> **Dev sênior:** *"E olha o que aconteceu semana passada: marcaram uma consulta para as 25h, porque alguém mexeu
...
> **Cliente:** *"Preciso enxergar como as coisas se ligam: um médico tem muitas consultas; cada consulta tem um paciente e um médico. Ah, e agora temos um novo
> tipo: **paciente de convênio** — parecido com o resto, mas tem valor diferente e exige autorização do convênio."*
>
> **Dev sênior:** *"Perfeito. **paciente de convênio** é um **tipo de paciente** (o teste do «é um»),
...
> **Dev sênior:** *"Hoje só temos um jeito de lidar com a forma de cobrança (particular ou convênio), mas isso VAI mudar.
...
>
> **Analista de qualidade:** *"E me mostrem, passo a passo, como acontece marcar uma consulta —
...
> **Analista:** *"A consulta anda **pulando etapa** e vira confusão. Precisa de fases
> bem definidas (marcada → confirmada → realizada; ou cancelada/faltou) e não deixar avançar fora de ordem — nem no papel, nem no código."*
>
> **Cliente:** *"E documenta o processo do agendamento até o atendimento: quero treinar a equipe nova com esse
> passo a passo."*

### 🗣️ Entrevista 8 — O sistema cresceu demais · *para os Encontros 16–17*
> **Tech lead:** *"Tá difícil mexer: a classe Consulta agenda, cobra E emite o comprovante — está tudo na mesma classe, e qualquer
> mudancinha quebra outra coisa. **Separem responsabilidades.**"*
>
> **Tech lead (depois):** *"E, quando terminarem, **simplifiquem**: a verificação de horário livre repetida em vários lugares, e joguem fora
> todo código que ninguém usa. Simples é melhor que 'esperto'."*

### 🗣️ Entrevista 9 — Organizar e publicar · *para os Encontros 18–19*
> **Arquiteto:** *"Vamos crescer o time: outro grupo vai assumir a parte de cobrança e prontuário.
> Precisamos separar isso em **módulos** com fronteiras claras, sem tudo dependendo de tudo."*
>
> **DevOps:** *"E me digam **onde** isso vai rodar: pensei em computadores na recepção e nos consultórios, com um banco central. Preciso planejar a
> infraestrutura e a segurança."*

### 🗣️ Entrevista 10 — A entrega final · *para o Encontro 20*
> **Cliente:** *"Chegou a hora: quero ver **rodando de ponta a ponta** — marcar uma consulta — do jeito
