...
> **Cliente (dono de um restaurante):** *"Minha ideia é simples: preciso organizar as mesas. Hoje faço
> tudo no caderno e me perco. Queria começar só cadastrando e vendo a lista. Depois a gente
> incrementa — já sei que vou precisar registrar os pedidos de cada comanda, mas uma coisa de cada vez."*
>
...
> guardar e fazer sobre comandas e sobre cada pedido."*
>
...
> **Cliente:** *"Tem uma regra que NÃO pode falhar de jeito nenhum: não pode abrir duas comandas para a mesma mesa ao mesmo tempo. Se isso
> acontecer, é prejuízo e dor de cabeça na certa."*
>
> **Dev sênior:** *"E olha o que aconteceu semana passada: o preço de um item ficou negativo, porque alguém mexeu
...
> **Cliente:** *"Preciso enxergar como as coisas se ligam: uma mesa tem uma comanda; a comanda é feita de vários pedidos. Ah, e agora temos um novo
> tipo: **cliente do rodízio** — parecido com o resto, mas paga um valor fixo em vez de somar item a item."*
>
> **Dev sênior:** *"Perfeito. **cliente do rodízio** é um **tipo de cliente** (o teste do «é um»),
...
> **Dev sênior:** *"Hoje só temos um jeito de lidar com a forma de dividir/pagar a conta (individual, por mesa), mas isso VAI mudar.
...
>
> **Analista de qualidade:** *"E me mostrem, passo a passo, como acontece abrir a comanda, pedir e fechar a conta —
...
> **Analista:** *"A comanda anda **pulando etapa** e vira confusão. Precisa de fases
> bem definidas (aberta → fechada → paga; itens podem ser cancelados) e não deixar avançar fora de ordem — nem no papel, nem no código."*
>
> **Cliente:** *"E documenta o processo da abertura da comanda ao pagamento: quero treinar a equipe nova com esse
> passo a passo."*

### 🗣️ Entrevista 8 — O sistema cresceu demais · *para os Encontros 16–17*
> **Tech lead:** *"Tá difícil mexer: a classe Comanda soma a conta, aplica a taxa de serviço E imprime — está tudo na mesma classe, e qualquer
> mudancinha quebra outra coisa. **Separem responsabilidades.**"*
>
> **Tech lead (depois):** *"E, quando terminarem, **simplifiquem**: o cálculo de conta com taxa/serviço/desconto embolado, e joguem fora
> todo código que ninguém usa. Simples é melhor que 'esperto'."*

### 🗣️ Entrevista 9 — Organizar e publicar · *para os Encontros 18–19*
> **Arquiteto:** *"Vamos crescer o time: outro grupo vai assumir a parte de salão (comandas) e cozinha (pedidos).
> Precisamos separar isso em **módulos** com fronteiras claras, sem tudo dependendo de tudo."*
>
> **DevOps:** *"E me digam **onde** isso vai rodar: pensei em tablets dos garçons, uma tela na cozinha e um caixa. Preciso planejar a
> infraestrutura e a segurança."*

### 🗣️ Entrevista 10 — A entrega final · *para o Encontro 20*
> **Cliente:** *"Chegou a hora: quero ver **rodando de ponta a ponta** — abrir a comanda, pedir e fechar a conta — do jeito
