...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o preço de um item (alguém pôs negativo). Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.restaurante.{dominio,aplicacao,infra}`).
