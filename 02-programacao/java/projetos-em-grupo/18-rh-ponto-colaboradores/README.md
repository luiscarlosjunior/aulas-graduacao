# 18 — RH: ponto e colaboradores

## 📞 O pedido do cliente
> "Sou do RH de uma empresa média. Preciso controlar os **colaboradores** e o **ponto** deles
> (entrada e saída de cada dia) pra fechar as horas no fim do mês. Cargos e departamentos
> também importam. Cálculo de folha completa é sonho distante, foco nas horas primeiro."

## 🧭 O que já sabemos
- Existem **colaboradores**, **cargos/departamentos** e **registros de ponto**.
- Cada colaborador tem um cargo e um departamento.
- O ponto registra horários de entrada e saída por dia.

## ❓ Perguntas em aberto (levantem com o "cliente")
- Como calcular horas trabalhadas e horas extras a partir do ponto?
- O registro de ponto é uma lista de marcações (composição do colaborador)?
- Há tipos de colaborador (CLT, estagiário) com regras diferentes?

## 🎚️ Complexidade sugerida
🟡 Bom para composição (Colaborador ◆ RegistroPonto) e cálculo derivado (horas).
...
> **Cliente (analista de RH de uma empresa média):** *"Minha ideia é simples: preciso organizar os colaboradores. Hoje faço
> tudo no caderno e me perco. Queria começar só cadastrando e vendo a lista. Depois a gente
> incrementa — já sei que vou precisar registrar os registros de ponto, mas uma coisa de cada vez."*
>
...
> guardar e fazer sobre colaboradores e sobre cada registro de ponto."*
>
...
> **Cliente:** *"Tem uma regra que NÃO pode falhar de jeito nenhum: não pode registrar saída antes da entrada no mesmo dia. Se isso
> acontecer, é prejuízo e dor de cabeça na certa."*
>
> **Dev sênior:** *"E olha o que aconteceu semana passada: registraram uma marcação de 30:00 horas, porque alguém mexeu
...
> **Cliente:** *"Preciso enxergar como as coisas se ligam: um colaborador tem muitos registros de ponto e pertence a um departamento. Ah, e agora temos um novo
> tipo: **colaborador estagiário** — parecido com o resto, mas tem carga horária e regras de hora extra diferentes."*
>
> **Dev sênior:** *"Perfeito. **colaborador estagiário** é um **tipo de colaborador** (o teste do «é um»),
...
> **Dev sênior:** *"Hoje só temos um jeito de lidar com a forma de cálculo das horas (mensalista, horista), mas isso VAI mudar.
...
>
> **Analista de qualidade:** *"E me mostrem, passo a passo, como acontece marcar o ponto e fechar as horas do mês —
...
> **Analista:** *"O registro de ponto do dia anda **pulando etapa** e vira confusão. Precisa de fases
> bem definidas (aberto (entrada) → fechado (saída); ou ajustado manualmente) e não deixar avançar fora de ordem — nem no papel, nem no código."*
>
> **Cliente:** *"E documenta o processo da marcação diária ao fechamento mensal: quero treinar a equipe nova com esse
> passo a passo."*

### 🗣️ Entrevista 8 — O sistema cresceu demais · *para os Encontros 16–17*
> **Tech lead:** *"Tá difícil mexer: a classe Colaborador calcula horas, gera o espelho de ponto E envia — está tudo na mesma classe, e qualquer
> mudancinha quebra outra coisa. **Separem responsabilidades.**"*
>
> **Tech lead (depois):** *"E, quando terminarem, **simplifiquem**: o cálculo de horas extras/adicionais cheio de exceções, e joguem fora
> todo código que ninguém usa. Simples é melhor que 'esperto'."*

### 🗣️ Entrevista 9 — Organizar e publicar · *para os Encontros 18–19*
> **Arquiteto:** *"Vamos crescer o time: outro grupo vai assumir a parte de ponto e folha (cálculo).
> Precisamos separar isso em **módulos** com fronteiras claras, sem tudo dependendo de tudo."*
>
> **DevOps:** *"E me digam **onde** isso vai rodar: pensei em o relógio de ponto, um servidor e um portal do colaborador. Preciso planejar a
> infraestrutura e a segurança."*

### 🗣️ Entrevista 10 — A entrega final · *para o Encontro 20*
> **Cliente:** *"Chegou a hora: quero ver **rodando de ponta a ponta** — marcar o ponto e fechar as horas do mês — do jeito
