...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: a hora marcada (registraram 30:00). Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.rh.{dominio,aplicacao,infra}`).
