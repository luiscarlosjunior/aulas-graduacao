...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o preço do serviço. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.petshop.{dominio,aplicacao,infra}`).
