...
- 📦 **Entregável:** uma **refatoração** separando responsabilidades — por ex.: hoje a classe Reserva calcula o valor, emite a fatura E manda o e-mail — separe cada responsabilidade.
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.hotel.{dominio,aplicacao,infra}`).
