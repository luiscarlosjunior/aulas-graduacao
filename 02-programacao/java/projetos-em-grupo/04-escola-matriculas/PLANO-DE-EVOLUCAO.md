...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: a nota (lançaram 15 numa escala de 0 a 10). Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.escola.{dominio,aplicacao,infra}`).
