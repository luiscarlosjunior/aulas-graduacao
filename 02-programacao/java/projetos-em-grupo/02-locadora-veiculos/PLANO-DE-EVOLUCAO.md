...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o valor da diária. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.locadora.{dominio,aplicacao,infra}`).
