...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: a taxa de reserva. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.condominio.{dominio,aplicacao,infra}`).
