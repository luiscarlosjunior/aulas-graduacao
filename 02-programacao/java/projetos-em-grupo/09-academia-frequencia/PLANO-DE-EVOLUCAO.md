...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o valor do plano. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.academia.{dominio,aplicacao,infra}`).
