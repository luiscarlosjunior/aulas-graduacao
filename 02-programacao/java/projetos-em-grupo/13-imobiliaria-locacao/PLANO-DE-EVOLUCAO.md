...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o valor do aluguel. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.imobiliaria.{dominio,aplicacao,infra}`).
