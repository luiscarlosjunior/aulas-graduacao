...
> **Cliente (gerente de uma seguradora):** *"Minha ideia é simples: preciso organizar as apólices. Hoje faço
> tudo no caderno e me perco. Queria começar só cadastrando e vendo a lista. Depois a gente
> incrementa — já sei que vou precisar registrar os sinistros de cada apólice, mas uma coisa de cada vez."*
>
...
> guardar e fazer sobre apólices e sobre cada sinistro."*
>
...
> **Cliente:** *"Tem uma regra que NÃO pode falhar de jeito nenhum: não pode abrir sinistro em uma apólice vencida ou cancelada. Se isso
> acontecer, é prejuízo e dor de cabeça na certa."*
>
> **Dev sênior:** *"E olha o que aconteceu semana passada: o valor da cobertura ficou negativo, porque alguém mexeu
...
> **Cliente:** *"Preciso enxergar como as coisas se ligam: um cliente tem várias apólices; cada apólice pode gerar vários sinistros. Ah, e agora temos um novo
> tipo: **apólice de vida** — parecido com o resto, mas tem regras de cobertura e cálculo de prêmio próprios."*
>
> **Dev sênior:** *"Perfeito. **apólice de vida** é um **tipo de apólice** (o teste do «é um»),
...
> **Dev sênior:** *"Hoje só temos um jeito de lidar com a forma de cálculo do prêmio (por idade, por risco), mas isso VAI mudar.
...
>
> **Analista de qualidade:** *"E me mostrem, passo a passo, como acontece abrir e analisar um sinistro —
...
> **Analista:** *"O sinistro anda **pulando etapa** e vira confusão. Precisa de fases
> bem definidas (aberto → em análise → aprovado/negado → pago) e não deixar avançar fora de ordem — nem no papel, nem no código."*
>
> **Cliente:** *"E documenta o processo da abertura do sinistro ao pagamento: quero treinar a equipe nova com esse
> passo a passo."*

### 🗣️ Entrevista 8 — O sistema cresceu demais · *para os Encontros 16–17*
> **Tech lead:** *"Tá difícil mexer: a classe Apolice calcula o prêmio, analisa o sinistro E emite o documento — está tudo na mesma classe, e qualquer
> mudancinha quebra outra coisa. **Separem responsabilidades.**"*
>
> **Tech lead (depois):** *"E, quando terminarem, **simplifiquem**: o cálculo de prêmio por perfil de risco cheio de ifs, e joguem fora
> todo código que ninguém usa. Simples é melhor que 'esperto'."*

### 🗣️ Entrevista 9 — Organizar e publicar · *para os Encontros 18–19*
> **Arquiteto:** *"Vamos crescer o time: outro grupo vai assumir a parte de apólices e sinistros.
> Precisamos separar isso em **módulos** com fronteiras claras, sem tudo dependendo de tudo."*
>
> **DevOps:** *"E me digam **onde** isso vai rodar: pensei em um portal do cliente, um servidor e um banco. Preciso planejar a
> infraestrutura e a segurança."*

### 🗣️ Entrevista 10 — A entrega final · *para o Encontro 20*
> **Cliente:** *"Chegou a hora: quero ver **rodando de ponta a ponta** — abrir e analisar um sinistro — do jeito
