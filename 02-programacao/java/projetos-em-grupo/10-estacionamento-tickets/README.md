...
> **Cliente (administrador de um estacionamento):** *"Minha ideia é simples: preciso organizar as vagas. Hoje faço
> tudo no caderno e me perco. Queria começar só cadastrando e vendo a lista. Depois a gente
> incrementa — já sei que vou precisar registrar os tickets de entrada/saída, mas uma coisa de cada vez."*
>
...
> guardar e fazer sobre vagas e sobre cada ticket."*
>
...
> **Cliente:** *"Tem uma regra que NÃO pode falhar de jeito nenhum: não pode ocupar uma vaga que já está ocupada. Se isso
> acontecer, é prejuízo e dor de cabeça na certa."*
>
> **Dev sênior:** *"E olha o que aconteceu semana passada: o valor da hora ficou negativo, porque alguém mexeu
...
> **Cliente:** *"Preciso enxergar como as coisas se ligam: uma vaga recebe um veículo por vez; cada ticket registra entrada e saída. Ah, e agora temos um novo
> tipo: **cliente mensalista** — parecido com o resto, mas tem vaga garantida e não paga por hora."*
>
> **Dev sênior:** *"Perfeito. **cliente mensalista** é um **tipo de cliente** (o teste do «é um»),
...
> **Dev sênior:** *"Hoje só temos um jeito de lidar com a forma de cobrança (por hora, diária, mensal), mas isso VAI mudar.
...
>
> **Analista de qualidade:** *"E me mostrem, passo a passo, como acontece registrar a entrada e a saída de um veículo —
...
> **Analista:** *"A vaga anda **pulando etapa** e vira confusão. Precisa de fases
> bem definidas (livre → ocupada → livre) e não deixar avançar fora de ordem — nem no papel, nem no código."*
>
> **Cliente:** *"E documenta o processo da entrada do veículo ao pagamento na saída: quero treinar a equipe nova com esse
> passo a passo."*

### 🗣️ Entrevista 8 — O sistema cresceu demais · *para os Encontros 16–17*
> **Tech lead:** *"Tá difícil mexer: a classe Ticket calcula o valor, libera a cancela E emite o recibo — está tudo na mesma classe, e qualquer
> mudancinha quebra outra coisa. **Separem responsabilidades.**"*
>
> **Tech lead (depois):** *"E, quando terminarem, **simplifiquem**: o cálculo de tarifa por fração de hora confuso, e joguem fora
> todo código que ninguém usa. Simples é melhor que 'esperto'."*

### 🗣️ Entrevista 9 — Organizar e publicar · *para os Encontros 18–19*
> **Arquiteto:** *"Vamos crescer o time: outro grupo vai assumir a parte de controle de vagas e cobrança.
> Precisamos separar isso em **módulos** com fronteiras claras, sem tudo dependendo de tudo."*
>
> **DevOps:** *"E me digam **onde** isso vai rodar: pensei em as cancelas de entrada/saída e um servidor central. Preciso planejar a
> infraestrutura e a segurança."*

### 🗣️ Entrevista 10 — A entrega final · *para o Encontro 20*
> **Cliente:** *"Chegou a hora: quero ver **rodando de ponta a ponta** — registrar a entrada e a saída de um veículo — do jeito
