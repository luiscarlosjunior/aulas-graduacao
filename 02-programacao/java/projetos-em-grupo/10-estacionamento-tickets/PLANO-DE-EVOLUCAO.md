...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o valor da hora. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.estacionamento.{dominio,aplicacao,infra}`).
