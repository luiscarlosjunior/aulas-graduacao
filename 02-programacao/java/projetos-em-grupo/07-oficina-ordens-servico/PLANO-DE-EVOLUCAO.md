...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o valor da mão de obra. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.oficina.{dominio,aplicacao,infra}`).
