...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o preço do produto. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.loja.{dominio,aplicacao,infra}`).
