...
> **Cliente (dono de uma loja online):** *"Minha ideia é simples: preciso organizar os produtos e os clientes. Hoje faço
> tudo no caderno e me perco. Queria começar só cadastrando e vendo a lista. Depois a gente
> incrementa — já sei que vou precisar registrar os pedidos, e cada pedido tem vários itens no carrinho, mas uma coisa de cada vez."*
>
...
> guardar e fazer sobre produtos e sobre cada pedido."*
>
...
> **Cliente:** *"Tem uma regra que NÃO pode falhar de jeito nenhum: não pode finalizar um pedido com produto sem estoque. Se isso
> acontecer, é prejuízo e dor de cabeça na certa."*
>
> **Dev sênior:** *"E olha o que aconteceu semana passada: o preço do produto ficou negativo, porque alguém mexeu
...
> **Cliente:** *"Preciso enxergar como as coisas se ligam: um cliente faz muitos pedidos; um pedido é feito de vários itens. Ah, e agora temos um novo
> tipo: **cliente VIP** — parecido com o resto, mas tem frete grátis e desconto progressivo."*
>
> **Dev sênior:** *"Perfeito. **cliente VIP** é um **tipo de cliente** (o teste do «é um»),
...
> **Dev sênior:** *"Hoje só temos um jeito de lidar com a forma de pagamento (cartão, Pix, boleto), mas isso VAI mudar.
...
>
> **Analista de qualidade:** *"E me mostrem, passo a passo, como acontece fechar o carrinho (checkout) —
...
> bem definidas (criado → pago → enviado → entregue; ou cancelado) e não deixar avançar fora de ordem — nem no papel, nem no código."*
>
> **Cliente:** *"E documenta o processo do carrinho à entrega: quero treinar a equipe nova com esse
> passo a passo."*

### 🗣️ Entrevista 8 — O sistema cresceu demais · *para os Encontros 16–17*
> **Tech lead:** *"Tá difícil mexer: a classe Pedido calcula o total, cobra E dispara o e-mail — está tudo na mesma classe, e qualquer
> mudancinha quebra outra coisa. **Separem responsabilidades.**"*
>
> **Tech lead (depois):** *"E, quando terminarem, **simplifiquem**: o cálculo de frete/desconto/cupom embolado, e joguem fora
> todo código que ninguém usa. Simples é melhor que 'esperto'."*

### 🗣️ Entrevista 9 — Organizar e publicar · *para os Encontros 18–19*
> **Arquiteto:** *"Vamos crescer o time: outro grupo vai assumir a parte de pagamento e envio (logística).
> Precisamos separar isso em **módulos** com fronteiras claras, sem tudo dependendo de tudo."*
>
> **DevOps:** *"E me digam **onde** isso vai rodar: pensei em o site, um servidor de aplicação, um banco e um gateway de pagamento. Preciso planejar a
> infraestrutura e a segurança."*

### 🗣️ Entrevista 10 — A entrega final · *para o Encontro 20*
> **Cliente:** *"Chegou a hora: quero ver **rodando de ponta a ponta** — fechar o carrinho (checkout) — do jeito
