...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: o preço do ingresso. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.cinema.{dominio,aplicacao,infra}`).
