...
> **Cliente (dono de um app de delivery):** *"Minha ideia é simples: preciso organizar os restaurantes e os clientes. Hoje faço
> tudo no caderno e me perco. Queria começar só cadastrando e vendo a lista. Depois a gente
> incrementa — já sei que vou precisar registrar os pedidos dos clientes, mas uma coisa de cada vez."*
>
...
> guardar e fazer sobre restaurantes e sobre cada pedido."*
>
...
> **Cliente:** *"Tem uma regra que NÃO pode falhar de jeito nenhum: não pode atribuir dois entregadores ao mesmo pedido. Se isso
> acontecer, é prejuízo e dor de cabeça na certa."*
>
> **Dev sênior:** *"E olha o que aconteceu semana passada: a taxa de entrega ficou negativa, porque alguém mexeu
...
> **Cliente:** *"Preciso enxergar como as coisas se ligam: um pedido é de um cliente e um restaurante, e é levado por um entregador. Ah, e agora temos um novo
> tipo: **cliente assinante** — parecido com o resto, mas tem entrega grátis acima de um valor."*
>
> **Dev sênior:** *"Perfeito. **cliente assinante** é um **tipo de cliente** (o teste do «é um»),
...
> **Dev sênior:** *"Hoje só temos um jeito de lidar com a forma de pagamento (na entrega ou online), mas isso VAI mudar.
...
>
> **Analista de qualidade:** *"E me mostrem, passo a passo, como acontece fazer um pedido até a entrega —
...
> **Analista:** *"O pedido anda **pulando etapa** e vira confusão. Precisa de fases
> bem definidas (recebido → em preparo → saiu para entrega → entregue; ou cancelado) e não deixar avançar fora de ordem — nem no papel, nem no código."*
>
> **Cliente:** *"E documenta o processo do pedido do cliente à entrega na porta: quero treinar a equipe nova com esse
> passo a passo."*

### 🗣️ Entrevista 8 — O sistema cresceu demais · *para os Encontros 16–17*
> **Tech lead:** *"Tá difícil mexer: a classe Pedido calcula o total, escolhe o entregador E notifica — está tudo na mesma classe, e qualquer
> mudancinha quebra outra coisa. **Separem responsabilidades.**"*
>
> **Tech lead (depois):** *"E, quando terminarem, **simplifiquem**: a lógica de taxa de entrega por distância cheia de casos, e joguem fora
> todo código que ninguém usa. Simples é melhor que 'esperto'."*

### 🗣️ Entrevista 9 — Organizar e publicar · *para os Encontros 18–19*
> **Arquiteto:** *"Vamos crescer o time: outro grupo vai assumir a parte de pedidos e logística de entrega.
> Precisamos separar isso em **módulos** com fronteiras claras, sem tudo dependendo de tudo."*
>
> **DevOps:** *"E me digam **onde** isso vai rodar: pensei em o app do cliente, o app do entregador, um servidor e um banco. Preciso planejar a
> infraestrutura e a segurança."*

### 🗣️ Entrevista 10 — A entrega final · *para o Encontro 20*
> **Cliente:** *"Chegou a hora: quero ver **rodando de ponta a ponta** — fazer um pedido até a entrega — do jeito
