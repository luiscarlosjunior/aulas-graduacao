...
- 📨 **Cliente:** *"Deu problema! Alguém colocou um valor absurdo: a taxa de entrega. Isso não podia acontecer."*
...
- 🔗 **No Java**, reorganize o código em pacotes por responsabilidade (`com.delivery.{dominio,aplicacao,infra}`).
