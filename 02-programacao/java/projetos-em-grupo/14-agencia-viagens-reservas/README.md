...
> **Cliente (dono de uma agência de viagens):** *"Minha ideia é simples: preciso organizar os pacotes. Hoje faço
> tudo no caderno e me perco. Queria começar só cadastrando e vendo a lista. Depois a gente
> incrementa — já sei que vou precisar registrar as reservas dos clientes, mas uma coisa de cada vez."*
>
...
> guardar e fazer sobre pacotes e sobre cada reserva."*
>
...
> **Cliente:** *"Tem uma regra que NÃO pode falhar de jeito nenhum: não pode reservar mais vagas do que o pacote oferece. Se isso
> acontecer, é prejuízo e dor de cabeça na certa."*
>
> **Dev sênior:** *"E olha o que aconteceu semana passada: o número de vagas ficou negativo, porque alguém mexeu
...
> **Cliente:** *"Preciso enxergar como as coisas se ligam: um pacote tem muitas reservas; cada reserva é de um cliente. Ah, e agora temos um novo
> tipo: **cliente com pacote premium** — parecido com o resto, mas inclui traslado e seguro-viagem."*
>
> **Dev sênior:** *"Perfeito. **cliente com pacote premium** é um **tipo de cliente** (o teste do «é um»),
...
> **Dev sênior:** *"Hoje só temos um jeito de lidar com a forma de pagamento (à vista, parcelado), mas isso VAI mudar.
...
>
> **Analista de qualidade:** *"E me mostrem, passo a passo, como acontece reservar um pacote —
...
> bem definidas (pendente → confirmada → concluída; ou cancelada) e não deixar avançar fora de ordem — nem no papel, nem no código."*
>
> **Cliente:** *"E documenta o processo da escolha do pacote à emissão do voucher: quero treinar a equipe nova com esse
> passo a passo."*

### 🗣️ Entrevista 8 — O sistema cresceu demais · *para os Encontros 16–17*
> **Tech lead:** *"Tá difícil mexer: a classe Reserva calcula o preço, cobra E emite o voucher — está tudo na mesma classe, e qualquer
> mudancinha quebra outra coisa. **Separem responsabilidades.**"*
>
> **Tech lead (depois):** *"E, quando terminarem, **simplifiquem**: o cálculo de preço com temporada/desconto/parcelamento confuso, e joguem fora
> todo código que ninguém usa. Simples é melhor que 'esperto'."*

### 🗣️ Entrevista 9 — Organizar e publicar · *para os Encontros 18–19*
> **Arquiteto:** *"Vamos crescer o time: outro grupo vai assumir a parte de pagamento e emissão de vouchers.
> Precisamos separar isso em **módulos** com fronteiras claras, sem tudo dependendo de tudo."*
>
> **DevOps:** *"E me digam **onde** isso vai rodar: pensei em um site de reservas, um servidor e um banco. Preciso planejar a
> infraestrutura e a segurança."*

### 🗣️ Entrevista 10 — A entrega final · *para o Encontro 20*
> **Cliente:** *"Chegou a hora: quero ver **rodando de ponta a ponta** — reservar um pacote — do jeito
