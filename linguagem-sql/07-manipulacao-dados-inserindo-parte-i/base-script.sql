-- =====================================================
-- SCRIPT BASE PARA MÓDULO 07 - MANIPULAÇÃO DE DADOS
-- Módulo 07: Sistema MusiStream - Estrutura Completa
-- =====================================================
-- Este script cria as tabelas principais do sistema MusiStream
-- com a estrutura completa para os exemplos de INSERT
-- demonstrados no README.md e exercícios.
-- =====================================================
...
-- =====================================================
-- Descomentar as linhas abaixo se quiser limpar estruturas existentes

/*
-- Remove tabelas na ordem correta (respeitando FKs)
DROP TABLE IF EXISTS historico_reproducao CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS playlist_musica CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS playlist CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS assinatura CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS musica CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS album CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS artista CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS genero CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS usuario CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS tipo_assinatura CASCADE CONSTRAINTS;

-- Remove sequences
DROP SEQUENCE IF EXISTS seq_usuario;
DROP SEQUENCE IF EXISTS seq_artista;
DROP SEQUENCE IF EXISTS seq_genero;
DROP SEQUENCE IF EXISTS seq_album;
DROP SEQUENCE IF EXISTS seq_musica;
DROP SEQUENCE IF EXISTS seq_playlist;
DROP SEQUENCE IF EXISTS seq_tipo_assinatura;
DROP SEQUENCE IF EXISTS seq_assinatura;
...
-- Exibir resumo das estruturas criadas
PROMPT =====================================================;
PROMPT ESTRUTURAS CRIADAS COM SUCESSO!;
PROMPT =====================================================;
PROMPT Sequences: 9 sequences para geração de IDs;
PROMPT Tabelas principais: genero, usuario, artista, album, musica;
PROMPT Tabelas de negócio: tipo_assinatura, assinatura, playlist;
PROMPT Tabelas de relacionamento: playlist_musica, historico_reproducao;
PROMPT =====================================================;
